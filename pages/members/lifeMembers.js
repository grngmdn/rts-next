...
const LifeMembers = () => {
  ...
  const getCollRef = collection(db, 'life_members');
  ...
  return (
    <div className='min-h-[73vh] w-full flex justify-center bg-gray-200'>
      <div className='max-w-[900px] w-[80vw] bg-gray-50 px-10 pt-10 pb-10'>
        <h1 className='text-3xl font-bold text-blue-500'>Life Members</h1>
        <div className='pt-5'>
          <DataTable
            columns={columns}
            data={filteredUsers}
            ...
            subHeaderComponent={
              <input
                ...
                className='shadow appearance-none border h-7 w-full text-sm rounded px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline'
